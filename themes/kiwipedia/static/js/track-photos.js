riot.tag2('track-photos', '<ul each="{photo in photos}"><li><img riot-src="{photo.thumbUrl}"></ul><img src="https://lh3.googleusercontent.com/-LD-VX6DSBbc/WGNnWAVHlII/AAAAAAAAACY/TWY8WtJz6Z4k2RTvcUKzY6sZoMFaVp7zQCHM/s180/2016-10-18%2B17.16.28.jpg">', '', '', function(opts) {
		console.log('kurva');
		var self = this;
		self.tracks = [];
		self.photos = [];
