riot.tag2('photo-gallery', '<div class="photo"></div><div class="gallery"><div each="{photo in gallery}" class="photo"><img riot-src="{photo.url}=h{photo.thumbnailHeight}" width="{photo.thumbnailWidth}" height="{photo.thumbnailHeight}"></div></div>', 'photo-gallery,[data-is="photo-gallery"]{ } photo-gallery .gallery,[data-is="photo-gallery"] .gallery{ } photo-gallery .gallery .photo,[data-is="photo-gallery"] .gallery .photo{ float: left; margin: 1px; font-size:0px; }', '', function(opts) {
		var self = this;
		self.photos = [];
		self.rows = 3;
		self.gallery = [];
